...
Shader "Shader Forge/Examples/GlassShader" {
    Properties {
        ...
        _Opacity ("Opacity", Range(0, 1)) = 0.4358974
...
////// Lighting:
                float3 finalColor = node_8334.rgb;
