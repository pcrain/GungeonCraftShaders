...
Shader "Shader Forge/Examples/GoldShader" {
    Properties {
        ...
        _SheenSpeed ("SheenSpeed", Range(0, 10)) = 1.643312
...
////// Specular:
                ...
                float2 node_521 = norm_uvs;
                float node_9013 = (_SheenAngle*(3.141592654/180.0));
                float2 sheen_norm = float2(cos(node_9013),sin(node_9013));
                float2 node_4044 = (node_521*sheen_norm).rg;
                float4 node_2594 = _Time;
                float3 diffuseColor = (node_8334.rgb+(_SheenColor.rgb*((saturate((sin((saturate((fmod(((node_4044.r+node_4044.g)+(node_2594.g*_SheenSpeed)),(1.0+_SheenSpacing))-_SheenSpacing))*3.141592654))-(1.0 - _SheenWidth)))*_SheenStrength)*(1.0 / _SheenWidth)))); // Need this for specular when using metallic
