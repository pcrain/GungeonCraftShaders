...
////// Emissive:
                ...
                float3 node_1504 = saturate(max((_ColorizeProgress*(node_1406.rgb*_Color.rgb)),node_8334.rgb));
                float3 finalColor = emissive + node_1504;
