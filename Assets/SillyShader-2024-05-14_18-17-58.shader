...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:1,cusa:False,bamd:0,cgin:,lico:0,lgpr:1,limd:3,spmd:1,trmd:0,grmd:0,uamb:False,mssp:True,bkdf:False,hqlp:False,rprd:True,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:True,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:0,x:34874,y:32343,varname:node_0,prsc:2|diff-1504-OUT,spec-5452-OUT,gloss-5452-OUT,amdfl-5108-OUT,amspl-5452-OUT,difocc-5108-OUT,spcocc-5452-OUT,custl-8334-RGB,alpha-8334-A,clip-8334-A;n:type:ShaderForge.SFN_Tex2dAsset,id:9706,x:34207,y:32635,ptovrint:False,ptlb:MainTex,ptin:_MainTex,varname:node_9706,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:32c295d87941a4142a911db9e6fbd446,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:8334,x:34446,y:32542,varname:node_8334,prsc:2,tex:32c295d87941a4142a911db9e6fbd446,ntxv:0,isnm:False|UVIN-6615-UVOUT,TEX-9706-TEX;n:type:ShaderForge.SFN_TexCoord,id:6615,x:34207,y:32478,varname:node_6615,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Tex2dAsset,id:7710,x:32982,y:32110,ptovrint:False,ptlb:ShaderTex,ptin:_ShaderTex,varname:node_7710,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Panner,id:3700,x:32844,y:32034,varname:node_3700,prsc:2,spu:0.25,spv:0.25|UVIN-1965-OUT,DIST-7060-T;n:type:ShaderForge.SFN_Tex2d,id:1127,x:33150,y:32026,cmnt:Timeshifted shader texture,varname:node_1127,prsc:2,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False|UVIN-3700-UVOUT,TEX-7710-TEX;n:type:ShaderForge.SFN_Blend,id:1504,x:34642,y:32181,varname:node_1504,prsc:2,blmd:10,clmp:True|SRC-5273-OUT,DST-8334-RGB;n:type:ShaderForge.SFN_Subtract,id:8065,x:33876,y:31841,varname:node_8065,prsc:2|A-1127-RGB,B-1182-OUT;n:type:ShaderForge.SFN_Multiply,id:6242,x:34109,y:31933,varname:node_6242,prsc:2|A-8065-OUT,B-2459-OUT;n:type:ShaderForge.SFN_Multiply,id:1965,x:32681,y:32034,cmnt:Normalized UVs of shader coords,varname:node_1965,prsc:2|A-9760-OUT,B-6907-OUT;n:type:ShaderForge.SFN_Time,id:7060,x:32681,y:32157,varname:node_7060,prsc:2;n:type:ShaderForge.SFN_Multiply,id:5273,x:34461,y:31987,varname:node_5273,prsc:2|A-4683-OUT,B-820-OUT;n:type:ShaderForge.SFN_Vector4,id:4683,x:34461,y:31884,varname:node_4683,prsc:2,v1:1,v2:0.7,v3:1,v4:1;n:type:ShaderForge.SFN_FragmentPosition,id:6803,x:31919,y:31887,varname:node_6803,prsc:2;n:type:ShaderForge.SFN_ComponentMask,id:9760,x:32455,y:31921,varname:node_9760,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-3009-OUT;n:type:ShaderForge.SFN_Fmod,id:3009,x:32280,y:31921,varname:node_3009,prsc:2|A-5554-OUT,B-6680-OUT;n:type:ShaderForge.SFN_Subtract,id:5554,x:32105,y:31823,varname:node_5554,prsc:2|A-8579-XYZ,B-6803-XYZ;n:type:ShaderForge.SFN_Reciprocal,id:6907,x:32280,y:32047,varname:node_6907,prsc:2|IN-6680-OUT;n:type:ShaderForge.SFN_Reciprocal,id:2018,x:33754,y:32119,varname:node_2018,prsc:2|IN-2459-OUT;n:type:ShaderForge.SFN_OneMinus,id:4437,x:33936,y:32075,varname:node_4437,prsc:2|IN-2018-OUT;n:type:ShaderForge.SFN_Slider,id:6680,x:31934,y:32047,ptovrint:False,ptlb:node_6680,ptin:_node_6680,varname:node_6680,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:1,cur:1.581197,max:8;n:type:ShaderForge.SFN_ObjectPosition,id:8579,x:31919,y:31733,varname:node_8579,prsc:2;n:type:ShaderForge.SFN_Vector1,id:5452,x:34642,y:32402,varname:node_5452,prsc:2,v1:1;n:type:ShaderForge.SFN_Vector1,id:5108,x:34642,y:32498,varname:node_5108,prsc:2,v1:0;n:type:ShaderForge.SFN_Relay,id:9167,x:34346,y:32706,cmnt:Opacity must match input texture to avoid spuriour lighting,varname:node_9167,prsc:2;n:type:ShaderForge.SFN_Multiply,id:4432,x:33936,y:32286,varname:node_4432,prsc:2|A-1127-RGB,B-2018-OUT;n:type:ShaderForge.SFN_Add,id:775,x:34109,y:32149,varname:node_775,prsc:2|A-4437-OUT,B-4432-OUT;n:type:ShaderForge.SFN_Reciprocal,id:9939,x:33583,y:31688,varname:node_9939,prsc:2|IN-2459-OUT;n:type:ShaderForge.SFN_OneMinus,id:1182,x:33827,y:31641,varname:node_1182,prsc:2|IN-9939-OUT;n:type:ShaderForge.SFN_Add,id:2459,x:33164,y:31702,varname:node_2459,prsc:2|A-7594-OUT,B-2515-OUT;n:type:ShaderForge.SFN_Vector1,id:2515,x:32931,y:31760,varname:node_2515,prsc:2,v1:1;n:type:ShaderForge.SFN_Abs,id:7594,x:32931,y:31579,varname:node_7594,prsc:2|IN-6171-OUT;n:type:ShaderForge.SFN_Slider,id:6171,x:32367,y:31629,ptovrint:False,ptlb:node_6171,ptin:_node_6171,varname:node_6171,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-7,cur:-1.999906,max:7;n:type:ShaderForge.SFN_If,id:820,x:34386,y:32157,varname:node_820,prsc:2|A-6596-OUT,B-6171-OUT,GT-6242-OUT,EQ-775-OUT,LT-775-OUT;n:type:ShaderForge.SFN_Vector1,id:6596,x:34143,y:32332,varname:node_6596,prsc:2,v1:0;proporder:9706-7710-6680-6171;pass:END;sub:END;*/

Shader "Shader Forge/Examples/SillyShader" {
    Properties {
        _MainTex ("MainTex", 2D) = "white" {}
        _ShaderTex ("ShaderTex", 2D) = "white" {}
        _node_6680 ("node_6680", Range(1, 8)) = 1.581197
        _node_6171 ("node_6171", Range(-7, 7)) = -1.999906
...
////// Specular:
                ...
                float3 node_775 = ((1.0 - node_2018)+(node_1127.rgb*node_2018));
