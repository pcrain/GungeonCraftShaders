    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += float3(float2((sin(((((node_6635.r*_WiggleIntensity)+node_2993.g)*_WiggleSpeed)+(node_6635.g*_WiggleDistort)))*_WIiggleDisplacement),0.0),0.0);
