...
Shader "Shader Forge/Examples/GlassShader" {
    Properties {
        ...
        _GlassDistort ("GlassDistort", Range(0, 1)) = 0.008547009
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 node_8906 = (node_7985.rgb.rg+(_ShimmerSpeed*node_1744.g)*float2(1,1));
                float node_1753 = 0.0;
                float2 node_1560 = (_RefractStrength + ( (abs(sin(node_8906)) - node_1753) * ((-1*_RefractStrength) - _RefractStrength) ) / (1.0 - node_1753));
                float2 node_5688 = (node_1560*_GlassDistort);
                float2 node_9754 = (node_5688+i.uv0);
