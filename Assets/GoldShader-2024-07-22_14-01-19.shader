...
////// Specular:
                ...
                float2 node_7939 = float2((((i.posWorld.rgb-objPos.rgb).rg*(1.0 / 2.0)).r+node_2594.g),0.0);
                float3 diffuseColor = (node_8334.rgb+float3(abs(sin(node_7939)),0.0)); // Need this for specular when using metallic
