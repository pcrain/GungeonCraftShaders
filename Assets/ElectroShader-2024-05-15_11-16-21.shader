...
Shader "Shader Forge/Examples/ElectroShader" {
    Properties {
        ...
        _PanSpeed ("PanSpeed", Range(0, 1)) = 1
        _RippleSpeed ("RippleSpeed", Range(0, 1)) = 0.7264957
