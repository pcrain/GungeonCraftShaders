...
////// Specular:
                ...
                float3 diffuseColor = saturate(max((_ColorizeProgress*(node_1406.rgb*_Color.rgb)),node_8334.rgb)); // Need this for specular when using metallic
...
////// Emissive:
                float node_1503 = (node_1406.r*_Emission);
                float3 emissive = float3(node_1503,node_1503,node_1503);
/// Final Color:
